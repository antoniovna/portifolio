  ...
  const showData = () => {
    ...
    for (let index = 0; index < Object.keys(data).length; index++) {
      ...
      for (let idx = 0; idx < data[element].length; idx++) {
        ...
        if (!dictData[element2[0]]) {
          dictData[element2[0]] = {
            LICITACAO_ID_ITEM: element2[0],
            items: [],
          };
        }
        dictData[element2[0]].items.push({
          ...
          PRECO_CUSTO_POR_UN: element2[30],
          PERC: element2[31],
          PRECO_CUSTO_CALCULADO_POR_UN: element2[32],
          PERC_CC: element2[33],
          ESTOQUE_ATUAL: element2[34],
          QUANTIDADE_POR_UNIDADE: element2[35],
          ESTOQUE_ATUAL_UNIDADE: element2[36],
          QTD_FATURADO: element2[37],
          QTD_A_FATURA: element2[38],
